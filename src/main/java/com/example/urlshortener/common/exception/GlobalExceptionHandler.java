...
import com.example.urlshortener.common.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles attempts to shorten known malicious URLs.
     */
    @ExceptionHandler(MaliciousUrlException.class)
    public ResponseEntity<ErrorResponse> handleMaliciousUrlException(MaliciousUrlException ex) {
        log.warn("Malicious URL detected: {}", ex.getMessage());
        ErrorResponse error = new ErrorResponse(
